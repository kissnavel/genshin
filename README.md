...
6、本仓库已整合：“<a href="https://github.com/ctrlcvs/xiaoyao-cvs-plugin">xiaoyao-cvs-plugin</a>”仓库的扫码登录、刷新ck等功能。

## 较原仓库新增的部分功能
1、本仓库支持绑定原神、星铁、绝区零、崩三、崩二、未定，支持国际服与国服，已完善查询逻辑，崩三、崩二、未定可基于本仓库自行开发查询功能。

2、“<a href="https://github.com/ctrlcvs/xiaoyao-cvs-plugin">xiaoyao-cvs-plugin</a>”仓库存储sk的yaml文件可复制进本仓库的yaml文件夹内使用，其余需调用此文件的插件需自行修改至本仓库存储路径。

3、部分功能默认关闭，如需使用自行开启，具体配置及功能查看相应文件，此处仅部分功能简写。
...
|#绑定设备帮助|查看如何绑定常用设备信息|
|#sk帮助|查看如何绑定sk|
|#扫码登录|扫码登录绑定sk与ck(仅支持国服)|
|#绑定sk|绑定sk并刷新ck|
|#刷新ck|通过已绑定的sk刷新ck|
|#更新抽卡记录|更新原神抽卡记录(仅支持国服)|
</details>
...
|#mys全部签到|米游社社区签到，支持原神、星铁、绝区零、崩三、崩二、未定、大别野、因缘精灵、星布谷地，可签到已绑定的全部sk(仅支持国服)|
|#米币查询|查询所有已绑定sk的米币(仅支持国服)|
|#我的sk|查询所有已绑定sk|
|#删除sk|删除所有已绑定sk|
</details>
