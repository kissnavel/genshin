...
export default class MysInfo {
  ...
  constructor(e) {
    ...
    // ck对应MysUser对象
    this.ckUser = null
    this.auth = ['dailyNote', 'spiralAbyss', 'character', 'ys_ledger', 'compute', 'avatarSkill', 'detail', 'blueprint', 'UserGame', 'deckList', 'avatar_cardList', 'action_cardList', 'avatarInfo', 'role_combat']
